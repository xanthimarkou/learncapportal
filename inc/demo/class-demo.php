...
if ( ! class_exists( 'Best_News_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Best_News_Demo {

		/**
		 * Singleton instance of Best_News_Demo.
		 *
		 * @var Best_News_Demo $instance Best_News_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Best_News_Demo ) ) {
				self::$instance = new Best_News_Demo();
